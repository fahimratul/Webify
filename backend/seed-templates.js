...
const defaultTemplates = [
  {
    ...
    description: "A sleek and modern dashboard UI kit with sidebar navigation, stat cards, and responsive layout.",
    type: "paid",
    price: 41,
    category: "dashboard",
  ...
  },
  {
    ...
    description: "A complete website landing page template with hero section, navigation, and feature cards.",
    type: "free",
    price: 0,
    category: "webpage",
  ...
  },
  {
    ...
    description: "A mobile messaging app UI mockup with phone frame, message list, and clean design.",
    type: "paid",
    price: 79,
    category: "dashboard",
  ...
  },
  {
    ...
    description: "A product showcase page with image gallery, pricing, reviews, and add-to-cart functionality.",
    type: "paid",
    price: 59,
    category: "portfolio",
  ...
  },
  {
    ...
    description: "A minimalist icon library grid layout with emoji icons and label text.",
    type: "free",
    price: 0,
    category: "dashboard",
  ...
  },
  {
    ...
    description: "Professional analytics dashboard with metric cards, date range selector, and growth indicators.",
    type: "paid",
    price: 89,
    category: "portfolio",
    image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=400&h=300&fit=crop",
...
async function seedTemplates() {
  try {
    ...
    if (existingCount > 0) {
      ...
      console.log(`✅ Seeded ${templatesWithAuthor.length} marketplace templates`);
    }
